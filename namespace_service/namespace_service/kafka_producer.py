...
from namespace_service.config import KAFKA_CONFIG
from namespace_service.schemas import StatisticMessage
from namespace_service.validators import json_dump
