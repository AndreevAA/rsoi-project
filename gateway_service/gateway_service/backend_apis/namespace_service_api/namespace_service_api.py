...
class NamespaceServiceAPI:
    ...
    async def get_namespaces(self, page: int, size: int, access_token: str) -> NamespacePagination:
        ...
        async with AsyncClient() as client:
            func: Awaitable = client.get(f'http://158.160.164.167/api/namespace-service/namespaces', headers=headers, params=params)
    ...
    async def get_namespace(self, namespace_id: UUID, access_token: str) -> NamespaceWithUsers:
        ...
        async with AsyncClient() as client:
            func = client.get(f'http://158.160.164.167/api/namespace-service/namespaces/{namespace_id}', headers=headers)
            response: Response | None = await self._circuit_breaker.request(func)
    ...
    async def create_namespace(self, namespace_input: InputNamespace, access_token: str) -> NamespaceModel:
        ...
        async with AsyncClient() as client:
            func = client.post(f'http://158.160.164.167/api/namespace-service/namespaces', headers=headers, json=body)
            response: Response | None = await self._circuit_breaker.request(func)
    ...
    async def delete_namespace(self, namespace_id: UUID, access_token: str) -> None:
        ...
        async with AsyncClient() as client:
            func = client.delete(f'http://158.160.164.167/api/namespace-service/namespaces/{namespace_id}', headers=headers)
            response: Response | None = await self._circuit_breaker.request(func)
    ...
    async def check_current_user_in_namespace(self, namespace_id: UUID, access_token: str) -> bool:
        ...
        async with AsyncClient() as client:
            func = client.get(f'http://158.160.164.167/api/namespace-service/namespaces/{namespace_id}/users/me', headers=headers)
            response: Response | None = await self._circuit_breaker.request(func)
    ...
    async def add_user_to_namespace(self, user_id: UUID, namespace_id: UUID, access_token: str) -> None:
        ...
        async with AsyncClient() as client:
            func = client.post(
                f'http://158.160.164.167/api/namespace-service/namespaces/{namespace_id}/users/{user_id}', headers=headers
            )
            response: Response | None = await self._circuit_breaker.request(func)
