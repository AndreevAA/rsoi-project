...
from identity_provider.config import KAFKA_CONFIG
from identity_provider.schemas import StatisticMessage
from identity_provider.validators import json_dump
