...
from category_service.config import KAFKA_CONFIG
from category_service.schemas import StatisticMessage
from category_service.validators import json_dump
