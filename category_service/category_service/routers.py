...
@router.get('/api/category-service/categories', status_code=status.HTTP_200_OK, response_model=CategoryPage)
...
@router.get('/api/category-service/categories/{category_id}', status_code=status.HTTP_200_OK, response_model=CategoryModel)
...
@router.post('/api/category-service/categories', status_code=status.HTTP_201_CREATED, response_model=CategoryModel)
